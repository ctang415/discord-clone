...
const Message = ({x, poster, index, fetchMessages, chatId}) => {
    ...
    return (
        <StyledList style={{display: 'flex', flexDirection: 'row', gap: '1.5em', padding: '0em'}} key={x.message}>
            <div style={ poster[index - 1] === poster[index] && index !== 0 ? { visibility: 'hidden'} : { marginTop: '1.5vh', visibility: 'visible'}}>
